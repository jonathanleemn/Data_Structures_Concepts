...
public class GradeBook
{
   ...
   //set of grades is going to be one row of the 2d Array called grades[]
   ...
   public void outputGrades()
   {
      ...
      for ( int student = 0; student < grades.length; student++ ) 
      {
         ...
         for ( int test : grades[ student ] ) // output each element in #student row of the 2d array
            System.out.printf( "%8d", test );//each column represents a test entered
