...
// Some things modified by cgorrill!  
//I demonstrate how to access a field with the same name as a local variable
//see lines 40 and 42
...
public class Scope
{
   ...
   public static void useLocalVariable()
   {
      ...
      ++Scope.x; // modifies field x
      System.out.printf( 
         "Field x used in useLocalVariable is %d\n", Scope.x );
