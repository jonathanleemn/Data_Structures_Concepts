 ...
 * @version 4.0
 */
public final class ResizableArrayBag<T extends Comparable> implements BagInterface<T>
{
	...
	@Override
	public T union(ResizableArrayBag<T> bag)
    {
	...
	@SuppressWarnings("unchecked")
	@Override
	public T intersection(ResizableArrayBag<T> bag)
	{
		BagInterface<T> newBag = new ResizableArrayBag<T>();
		T[] mine = this.toArray();
		T[] other = bag.toArray();
	...
	@Override
	public T difference(ResizableArrayBag<T> bag){
		BagInterface<T> newBag = new ResizableArrayBag<T>();
		T[] mine = this.toArray();
		T[] other = bag.toArray();
